...
// Теперь создаём в «main.js» прослушку на 'userName' 
...
// inform new user about LastConvertedList
socket.on('newUserErase', function(EraseMe){ // Думаю тут понятно уже =)
console.log('NewUser erase lastConvertedList | ' + EraseMe); // Логгирование
